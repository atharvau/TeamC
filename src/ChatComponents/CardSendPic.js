...
class CardSendPic extends Component {
  ...
  onClick = () => {
    ...
    axios
      .post(
        "https://restinbase.herokuapp.com/msg",
        JSON.stringify({ key: key22 }),
        {
          headers: headers
        }
      )
    ...
    if (n > 0) {
      ...
      axios
        .post(
          "https://restinbase.herokuapp.com/note",
          JSON.stringify({ key: key22 }),
          {
            headers: headers
          }
    ...
    if (f > 0) {
      ...
      axios
        .post(
          "https://restinbase.herokuapp.com/todo",
          JSON.stringify({ key: key22 }),
          {
            headers: headers
          }
    ...
    if (Poll.title.Pol != null) {
      ...
      axios
        .post(
          "https://restinbase.herokuapp.com/poll",
          JSON.stringify({ key: key22 }),
          {
            headers: headers
          }
